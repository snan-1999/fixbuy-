            ...
            <MyContainer>
                ...
                <div className="container post border p-0">
                    ...
                    <div className="container set-pd-post">
                        ...
                        {title.length > 60 &&
                            ...
                            <div className="titleerrormsg" style={{ color: "red", fontSize: "10px" }} >{titleerror}</div>
                        }

                        {/* {AllErrors ? <p style={{ color: 'red' }}>Name is required</p> : null} */}
                        <br />
                        ...
                        {description.length > 300 &&
                            <div className="titleerrormsg" style={{ color: "red", fontSize: "10px" }} >{descriptionerror}</div>
                        }
                        <br />
                ...
                <label for="description">SET PRICE</label>
                    ...
                    <div className="container set-pd-post">
                        ...
                        <Stack spacing={3}>
                            {AllErrors && <Text color='tomato' fontSize='13px' mt='5'>Invalid Fields </Text>}
                        </Stack>
                        {/* <div className="text-danger fs-6">{AllErrors && "Fields Invalid"}</div> */}

          ...
          <div className="container-price">
            <div className="row">
              ...
              <div className="col-lg-6 ">
                <div className="card mb-5 mb-lg-0" id='setMargin1_'>
                  <div className="card-body">
                    ...
                    <hr />
                    <ul className="fa-ul">
                      {/* //   <!-- <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>Boost your mobiles ads on top</li> --> */}
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>For 3 days</li>
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>2x more buyers</li>
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>Customer engagements</li>
                      {/* <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>All
                        items boost</li> */}
                      {/* //       <!-- <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>Dedicated
              ...
              {/* //   <!-- Plus Tier --> */}
              <div className="col-lg-6">
                <div className="card mb-5 mb-lg-0" id='setMargin2_'>
                  <div className="card-body">
                    ...
                    <hr />
                    <ul className="fa-ul">
                      {/* //   <!-- <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>Boost your bikes ads on top</li> --> */}
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>For 5 days</li>
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>2x more buyers</li>
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>Customer engagement</li>
                      {/* <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>All
                        items boosts</li> */}
                      {/* //       <!-- <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>Dedicated
                // technical Support</li> --> */}
                ...
                <div className="card mb-5 mb-lg-0" id='setMargin1_'>
                  <div className="card-body">
                    ...
                    <ul className="fa-ul">
                      ...
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>For 3 days</li>
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>2x more buyers</li>
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>All Ads Boosted</li>
                      <li className="text-capitalize"><span className="fa-li"><FontAwesomeIcon icon="fas fa-check"></FontAwesomeIcon></span>Customer engagements</li>
                      {/* <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>All
                        items boost</li> */}
                      {/* //       <!-- <li className="text-capitalize"><span className="fa-li"><i className="fas fa-check"></i></span>Dedicated
...
export default PakagesShowMenu;